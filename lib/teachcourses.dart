...
import 'package:iftikhars_project/takeatt.dart';
import 'package:iftikhars_project/transcript1.dart';

class teachcourses extends StatelessWidget {
  final String rn;

  teachcourses({required this.rn});
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => AttendancePage(rollNumber: rn,lectureNumber:  2)));
