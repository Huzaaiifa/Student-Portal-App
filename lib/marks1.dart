        ...
        child: Stack(
            children: <Widget>[
              Positioned(
                  ...
                  top: 44,
                  left: 145,
                  child: Text('Marks', textAlign: TextAlign.left, style: TextStyle(
                  ...
                  top: 175,
                  left: 100,
                  child: Text('Software Engineering', textAlign: TextAlign.left, style: TextStyle(
                      color: Color.fromRGBO(255, 255, 255, 1),
                      fontFamily: 'Jost',
                      fontSize: 12,
                      letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
                  ...
                  top: 470,
                  left: 66,
                  child: Text('Assignments', textAlign: TextAlign.left, style: TextStyle(
                      color: Color.fromRGBO(255, 255, 255, 1),
                      fontFamily: 'Jost',
                      fontSize: 14,
                      letterSpacing: 0.25,
                  ...
                  top: 506.87945556640625,
                  left: 284,
                  child: Transform.rotate(
                    angle: 89.99999999999999 * (math.pi / 180),
                    child: Container(
                        width: 33.87944412231445,
                        height: 27.376117706298828,
                        decoration: BoxDecoration(
                          image : DecorationImage(
                              image: AssetImage('assets/images/Downbutton.png'),
                              fit: BoxFit.fitWidth
                  ...
                  top: 535,
                  left: 66,
                  child: Text('Grand Total Marks', textAlign: TextAlign.left, style: TextStyle(
                      color: Color.fromRGBO(255, 255, 255, 1),
                      fontFamily: 'Jost',
                      fontSize: 14,
                      letterSpacing: 0.25,
                  ...
                  top: 220,
                  left: 54,
                  child: Text('Quizzes:', textAlign: TextAlign.left, style: TextStyle(
                  ...
                  top: 273,
                  left: 54,
                  child: Text('Sr no.', textAlign: TextAlign.left, style: TextStyle(
                      color: Color.fromRGBO(0, 0, 0, 1),
                      fontFamily: 'Jost',
                      fontSize: 11.5,
                      letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
                  ...
                  top: 273,
                  left: 93,
                  child: Text('Weightage', textAlign: TextAlign.left, style: TextStyle(
                      color: Color.fromRGBO(0, 0, 0, 1),
                      fontFamily: 'Jost',
                      fontSize: 11.5,
                      letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
                  ...
                  top: 267,
                  left: 161,
                  child: Text('Obtained marks', textAlign: TextAlign.center, style: TextStyle(
                      color: Color.fromRGBO(0, 0, 0, 1),
                      fontFamily: 'Jost',
                      fontSize: 11.5,
                      letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
                  ...
                  top: 273,
                  left: 222,
                  child: Text('Total marks', textAlign: TextAlign.left, style: TextStyle(
                      color: Color.fromRGBO(0, 0, 0, 1),
                      fontFamily: 'Jost',
                      fontSize: 11.5,
                      letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
                  ...
                  top: 273,
                  left: 287,
                  child: Text('Aver', textAlign: TextAlign.left, style: TextStyle(
                      color: Color.fromRGBO(0, 0, 0, 1),
                      fontFamily: 'Jost',
                      fontSize: 11.5,
                      letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
