...
class ahome extends StatefulWidget {
  ...
  ahome({required this.rn});

  @override
  _thome createState() => _thome();
}

class _thome extends State<ahome> {
                            ...
                            children: [
                              ...
                              IntrinsicHeight(
                                child: customExpandableTile(
                                  title: 'personal info',
                                  content: Text(
                                    '${userData?['personal information'] ?? 'No contact Information'}',
                                    style: TextStyle(
                                        fontSize: 14,
                                        color: Colors.black.withOpacity(1.0),
                                        fontWeight: FontWeight.w600),
                              ...
                              IntrinsicHeight(
                                child: customExpandableTile(
                                  ...
                                  content: Text(
                                    '${userData?['contact'] ?? 'No family Information'}',
                                    style: TextStyle(
                                        fontSize: 14,
                                        color: Colors.black.withOpacity(1.0),
                                        fontWeight: FontWeight.w600),
